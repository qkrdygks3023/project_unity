...
public class dataController : MonoBehaviour
{
    ...
    public void JsonSave()
    {
        ...
        saveData.Data0.Add(new Datajson("기록영상", 0000, "한국에 무스탕 MUSTANGA IN KOREA", "미국 NARA", "/", new List<string> { "항공 조종사", "공장", "비행기 격납고", "군용기", "대포", "로켓 (대포)", "무스탕 (전투기)", "정비공 (인물)" }, 517, "전쟁의 참상을 표현한다 다큐멘터리", "/movies/00/2_한국에 무스탕.mp4", "/images/00/ing.png"));
        ...
        saveData.Data0.Add(new Datajson("기록영상", 0000, "부산에서의 활동, 한국 ACTIVITIES AT PUSAN, KOREA", "미국 NARA", "/", new List<string> { "민간인 대피", "한국인", "포로", "신병 모집과 협조", "선박", "사찰", "지프차", "경비병" }, 595, "전쟁의 참상을 표현한다 다큐멘터리", "/movies/00/8_부산에서의 활동, 한국.mp4", "/images/00/ing.png"));
        saveData.Data0.Add(new Datajson("기록영상", 0000, "유엔 서울 안으로 후퇴, 서울 UN RETREAT INTO SEOUL, KOREA", "미국 NARA", "/", new List<string> { "군용트럭", "나룻배", "수여식", "사진사", "피난민", "배식", "취사", "LP" }, 595, "전쟁의 참상을 표현한다 다큐멘터리", "/movies/00/9_유엔 서울로 후퇴, 서울.mp4", "/images/00/ing.png"));



        saveData.Data1.Add(new Datajson("전쟁영화", 2004, "육탄 11용사", "국방홍보원", "2004년", new List<string> { "6·25전쟁", "호국인물", "6사단" }, 3049, "6.25 당시 소련제 탱크를 앞세운 북한군의 기습 남침으로 아국의 전 전선이 초토화 직전의 위기에 처할 무렵, 춘천 방어의 마지막 보루였던 홍천 말고개에서 거의 맨손으로 적 탱크를 격파하며 아군의 작전에 유리한 전기를 마련한 육군 제6사단 19연대 소속 육탄 11용사들의 백절불굴의 투혼과 감투정신을 보여주는 내용으로 이루어져 있다.", "/movies/01/1. 육탄 11용사.mp4", "/images/01/1. 육탄 11용사.jpg"));
        saveData.Data1.Add(new Datajson("전쟁영화", 1951, "정의의 진격 1부", "한국영상자료원", "1951년", new List<string> { "6·25전쟁" }, 4846, "1950년대 초, 대한민국국방부정훈국에서 제작한 한국전쟁 관련 기록영화이다. 동란 중 촬영된 영상을 음성해설과 함께 재구성해 한국전쟁의 전개 과정을 연대기 순으로 보여준다.", "/movies/01/2. 정의의 진격 1부.mp4", "/images/01/ing.png"));
        saveData.Data1.Add(new Datajson("전쟁영화", 1952, "태양의 거리(무성영화)", "한국영상자료원", "1952년", new List<string> { "6·25전쟁", "대구", "피난", "피난민", "우정", "불량소년" }, 3851, "국민학교 교사 문대식(박암)이 피란지 대구로 부임해 온다. 피난 생활상과 불량 소년들의 모습 그리고 우정과 변화를 보여준다.", "/movies/01/3. 태양의 거리(무성영화).mp4", "/images/01/ing.png"));
        saveData.Data1.Add(new Datajson("전쟁영화", 1954, "운명의 손", "한국영상자료원", "1954년", new List<string> { "6·25전쟁" }, 5390, "북한의 스파이로 활동하는 마가렛(윤인자)은 우연히 도둑으로 몰린 고학생 신영철(이향)을 구해주며 사랑에 빠진다. 자신의 마음을 고백한 마가렛은 영철과 즐거운 시간을 보내지만, 그 과정에서 간첩으로서의 정체성과 영철과의 사랑 사이에서 번민한다.", "/movies/01/4. 운명의 손.mp4", "/images/01/ing.png"));
        saveData.Data1.Add(new Datajson("전쟁영화", 1955, "미망인", "한국영상자료원", "1955년", new List<string> { "6·25전쟁", "6·25전쟁직후", "미망인", "전쟁미망인", "여성감독" }, 3731, "딸 주(이성주)를 데리고 피난생활을 하는 이신자(이민자)는 6·25 때 죽은 남편의 친구였던 이성진 사장(신동훈)의 도움으로 생계를 유지한다. 그러나 친구의 아내를 도와주어야 한다는 이 사장의 도의심은 신자에 대한 애정으로 변한다. 이를 눈치 챈 이 사장의 처(박영숙)는 남편을 추궁한다.", "/movies/01/5. 미망인.mp4", "/images/01/ing.png"));
        saveData.Data1.Add(new Datajson("전쟁영화", 1956, "피아골", "한국영상자료원", "1956년", new List<string> { "6·25전쟁" }, 6505, "휴전 후 지리산에 남아 있는 소수의 빨치산 중 아가리(이예춘)가 대장을 맡고 있는 부대는 온갖 만행을 저지른다. 공산주의 이념에 회의를 느끼기 시작한 철수(김진규)는 당성이 높고 냉철한 여자 대원 애란(노경희)의 연모를 받으며 고민한다. ", "/movies/01/6. 피아골.mp4", "/images/01/ing.png"));
        saveData.Data1.Add(new Datajson("전쟁영화", 1956, "격퇴(우리는 이렇게 싸웠다)", "한국영상자료원", "1956년", new List<string> { "6·25전쟁", "김만술", "실화바탕", "이강천" }, 5055, "김만술 대위의 6.25 참전 실화를 영화화한 작품. 한국군은 베티고지 사수가 어려움에도 불구하고 김만술 소대장과 선임하사 김무철 상사(최봉)을 포함한 소대원들은 고지를 지키기 위해 전력을 다한다.", "/movies/01/7. 격퇴(우리는 이렇게 싸웠다).mp4", "/images/01/ing.png"));
        saveData.Data1.Add(new Datajson("전쟁영화", 1958, "지옥화", "한국영상자료원", "1958년", new List<string> { "6·25전쟁", "신상옥" }, 5180, "영식(김학) 일당은 기지촌에서 살면서 미군부대의 창고를 털어 시장에 내다 파는 일을 한다. 동생 동식(조해원)은 형 영식을 설득해 고향으로 데려가기 위해 서울에 왔다가 시장 통에서 형을 발견하고 그를 따라 기지촌으로 들어간다. ", "/movies/01/8. 지옥화.mp4", "/images/01/ing.png"));
        saveData.Data1.Add(new Datajson("전쟁영화", 1958, "동심초", "한국영상자료원", "1958년", new List<string> { "6·25전쟁", "신상옥" }, 7579, "6ㆍ25때 남편을 여읜지 8년. 이숙희(최은희)는 양장점을 하다가 빚을 지고, 출판사 전무 김상규(김진규)가 빚청산을 도와주면서 둘은 사랑에 빠진다.", "/movies/01/9. 동심초.mp4", "/images/01/ing.png"));
        ...
        saveData.Data2.Add(new Datajson("다큐멘터리", 1957, "상기하자 6.25", "한국정책방송원", "1957년", new List<string> { "한국전쟁", "6.25전쟁", "국립영화제작소" }, 2207, "", "/movies/02/3. 상기하자  6.25.mp4", "/images/02/ing.png"));
        saveData.Data2.Add(new Datajson("다큐멘터리", 1995, "시련과 영광", "한국정책방송원", "1995년", new List<string> { "한국전쟁", "6.25전쟁", "국립영상제작소", "광복50주년" }, 3171, "1995년 광복 50주년을 기념하여 국립영상제작소에서 제작한 기록영상이다. 해방 이후 분단의 아픔을 딛고 일어서 한강의 기적을 이루고, 군사독재의 시련을 견디고 문민정부를 수립하기까지의 아팠지만 대견한 50년의 역사의 순간들을 담은 영상물이다.", "/movies/02/2. 시련과 영광.mp4", "/images/02/9. 시련과 영광.jpg"));
